...
\begin{frame}{Relevance Model features}
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item concept formerly explored by the Bianconi–Barabási model
        \end{itemize}
...
\begin{frame}{Relevance decay: a real-world example}
    \begin{figure}
        \includegraphics[width=0.8\textwidth]{figures/RelevanceDecayAPS}
        ...
        Papers are clustered in three classes, by their indegree.}
    \end{figure}
\end{frame}
